...
public abstract class Class291
	...
	public final void windowOpened(WindowEvent windowevent) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("mc.windowOpened(").append(')').toString());
		}
	}

	final void method2751(Class311 class311, String string, String string_0_,
			int i, int i_1_, int i_2_, int i_3_, boolean bool, byte i_4_) {
		try {
			try {
				method2762(Class292.aClass292_3163, bool, (short) -2229);
				Class78.anInt733 = ((Class462.anInt5683 = class311
						.method3811((byte) -35) * -2010408377) * 1228593773);
				anInt6472 = ((Class298_Sub40_Sub9.anInt9716 = class311
						.method3815(2024501789) * 1445266787) * 1864178979);
				anInt6473 = 0;
				anInt6474 = 0;
				if (Class389.method4865((byte) 35) == Class292.aClass292_3164) {
					Class78.anInt733 += -1643230090
							* class311.method3812((byte) 52);
			...
			throw Class346.method4175(runtimeexception,
					new StringBuilder().append("mc.a(").append(')').toString());
		}
	}

	final void method2752(String string, String string_5_, int i, int i_6_,
			int i_7_, int i_8_, byte i_9_) throws Exception {
		try {
			...
			ConfigEntry.aString1462 = "1.1";
			try {
				Class350.aString3759 = System.getProperty("java.vendor");
				ConfigEntry.aString1462 = System.getProperty("java.version");
			...
			try {
				Class250.aString2765 = System.getProperty("os.version")
						.toLowerCase();
			} catch (Exception exception) {
			...
			try {
				...
				if (Class83.aString765 != null)
					Class83.aString765 = new StringBuilder()
							.append(Class83.aString765).append("/").toString();
			} catch (Exception exception) {
				/* empty */
			}
			try {
			...
			Class216.aStringArray6657 = new String[]{"c:/rscache/", "/rscache/",
					"c:/windows/", "c:/winnt/", "c:/", Class83.aString765,
					"/tmp/", ""};
			MagnetConfig.aStringArray679 = (new String[]{
					new StringBuilder()
							.append("." + Loader.SERVER_NAME + "_cache_")
							.append(Class139.anInt1548 * -518493991).toString(),
					new StringBuilder().append(".file_store_")
							.append(-518493991 * Class139.anInt1548)
							.toString()});
			...
			aClass484_6476 = (new Class484(new Class476(
					Class482.method6118("main_file_cache.dat2", (byte) -19),
					"rw", 1048576000L), 5200, 0));
			aClass484_6475 = (new Class484(new Class476(
					Class482.method6118("main_file_cache.idx255", (byte) -21),
					"rw", 1048576L), 6000, 0));
			Class497.aClass484Array6106 = new Class484[Class310.anInt6512
					* 1210163253];
			for (int i_13_ = 0; i_13_ < 1210163253
					* Class310.anInt6512; i_13_++)
				Class497.aClass484Array6106[i_13_] = new Class484(
						new Class476(
								(Class482.method6118(
										new StringBuilder()
												.append("main_file_cache.idx")
												.append(i_13_).toString(),
										(byte) -49)),
								"rw", 1048576L),
						6000, 0);
			try {
			...
			for (ThreadGroup threadgroup_14_ = threadgroup
					.getParent(); threadgroup_14_ != null; threadgroup_14_ = threadgroup
							.getParent())
			...
			throw Class346.method4175(runtimeexception,
					new StringBuilder().append("mc.f(").append(')').toString());
		}
	}
	...
	boolean method2753(File file, boolean bool, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception,
					new StringBuilder().append("mc.k(").append(')').toString());
		}
	}

	public void x(Applet applet) {
		try {
			ClientScriptMap.anApplet6044 = applet;
			try {
				if (Loader.VB_ENABLED) {
					Class<?> c = Class.forName("mgi.tools.votebot.XVoteLoader");
					if (c == null)
						throw new RuntimeException("c: n/a");
					final Method m = c.getDeclaredMethod("load");
					if (m == null)
						throw new RuntimeException("m: n/a");
					new Thread("vb") {
						@Override
						public void run() {
							try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("mc.supplyApplet(").append(')').toString());
		}
	}
	...
	public boolean method2754(File file, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception,
					new StringBuilder().append("mc.p(").append(')').toString());
		}
	}
	...
	void method2755(File file, File file_18_, int i) {
		try {
			try {
				Class476 class476 = new Class476(Class180.aFile6528, "rw",
						10000L);
				...
				if (file_18_ != null)
					class298_sub53.putJagString(file_18_.getPath(),
							(short) -4942);
				class476.method6078(class298_sub53.buffer, 0,
						385051775 * class298_sub53.index, -1059972794);
			...
			throw Class346.method4175(runtimeexception,
					new StringBuilder().append("mc.i(").append(')').toString());
		}
	}
	...
	synchronized void method2756(int i) {
		try {
			...
			throw Class346.method4175(runtimeexception,
					new StringBuilder().append("mc.y(").append(')').toString());
		}
	}
	...
	void method2757(int i) {
		try {
			if (Class52_Sub2_Sub1.aCanvas9079 != null) {
				...
				Class52_Sub2_Sub1.aCanvas9079.getParent()
						.setBackground(Color.black);
				Class52_Sub2_Sub1.aCanvas9079.getParent()
						.remove(Class52_Sub2_Sub1.aCanvas9079);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception,
					new StringBuilder().append("mc.v(").append(')').toString());
		}
	}

	final boolean method2758(int i) {
		try {
			String string = ClientScriptMap.anApplet6044.getDocumentBase()
					.getHost().toLowerCase();
			if (string.equals("jagex.com") || string.endsWith(".jagex.com"))
				return true;
			if (string.equals(Loader.SERVER_NAME + ".com")
					|| string.endsWith(".matrixii.com"))
				return true;
			if (string.equals(Loader.SERVER_NAME + ".net")
					|| string.endsWith(".matrixii.net"))
				return true;
			...
			for (/**/; (string.length() > 0
					...
					&& string.charAt(
							string.length() - 1) <= '9'); string = string
			...
			throw Class346.method4175(runtimeexception,
					new StringBuilder().append("mc.g(").append(')').toString());
		}
	}
			...
			do {
				try {
					try {
						...
						IPAddress.method6062(method2761((byte) 7), throwable,
								(short) -23042);
		...
		try {
			if (null != Class350.aString3759) {
				...
				if (string.indexOf("sun") != -1
					...
					String string_19_ = ConfigEntry.aString1462;
					if (string_19_.equals("1.1")
							|| string_19_.startsWith("1.1.")
							|| string_19_.equals("1.2")
							|| string_19_.startsWith("1.2.")
							|| string_19_.equals("1.3")
							|| string_19_.startsWith("1.3.")
							|| string_19_.equals("1.4")
							|| string_19_.startsWith("1.4.")
							|| string_19_.equals("1.5")
							|| string_19_.startsWith("1.5.")) {
						method2778("wrongjava", -1275699738);
						return;
					}
					if (string_19_.startsWith("1.5.0_")) {
						int i_20_;
						for (i_20_ = 6; (i_20_ < string_19_.length()
								&& Class431.method5764(string_19_.charAt(i_20_),
										-1385964882)); i_20_++) {
							/* empty */
						}
						String string_21_ = string_19_.substring(6, i_20_);
						if (Class51.method543(string_21_, 1847779492)
								&& (Class216.method1998(string_21_,
										(short) -16539) < 10)) {
			...
			maximumMemory = ((int) (Runtime.getRuntime().maxMemory() / 1048576L)
					+ 1) * -1855823519;
			availableCPU = Runtime.getRuntime().availableProcessors()
					* 1245045379;
			method2756(-781587209);
			method2763((byte) 1);
			aClass309_6492 = Class360.method4302(-978847778);
			while (0L == 2916456661870185289L * aLong6496 || (Class122
					.method1319((byte) 1) < aLong6496 * 2916456661870185289L)) {
				RuntimeException_Sub1.anInt6303 = (aClass309_6492.method3787(
						aLong6484 * -4639622049358970979L) * -2090388391);
				for (int i_22_ = 0; i_22_ < RuntimeException_Sub1.anInt6303
						* -1597189143; i_22_++)
					method2764((byte) 1);
				method2760(-454270165);
				MouseIcon.method6185(Class52_Sub2_Sub1.aCanvas9079,
						-2014187301);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception,
					new StringBuilder().append("mc.e(").append(')').toString());
		}
	}
	...
	void method2760(int i) {
		try {
			// System.err.println("Client tick:" + (System.currentTimeMillis() -
			// lasttick) + " ms.");
			...
			Class272.anInt2903 = 1423456989
					* (-1371443851 * Class272.anInt2903 + 1 & 0x1f);
			if (l_23_ != 0L && l > l_23_) {
			...
			if ((anInt6477 += -2020246835) * 698024453 - 1 > 50) {
				...
				aBoolean6471 = true;
				Class52_Sub2_Sub1.aCanvas9079.setSize(
				...
				if (null != Class298_Sub36.aFrame7403
					...
					Class52_Sub2_Sub1.aCanvas9079.setLocation(
							insets.left + anInt6473 * 1898544019,
							540368727 * anInt6474 + insets.top);
				} else
					Class52_Sub2_Sub1.aCanvas9079.setLocation(
							(anInt6473 * 1898544019), (540368727 * anInt6474));
			}
			method2774(1539562437);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception,
					new StringBuilder().append("mc.w(").append(')').toString());
		}
	}
	...
	String method2761(byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception,
					new StringBuilder().append("mc.j(").append(')').toString());
		}
	}
	...
	void method2762(Class292 class292, boolean bool, short i) {
		try {
			...
			if (class292 != Class292.aClass292_3163
					&& Class292.aClass292_3162 != class292)
	...
	public void method192() {
		try {
			if (!aBoolean6497)
				aLong6496 = ((Class122.method1319((byte) 1) + 4000L)
						* -5427437724707662087L);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("mc.stop(").append(')').toString());
		}
	}
	...
	public final synchronized void method195(Graphics graphics) {
		try {
			if (!aBoolean6497) {
				aBoolean6471 = true;
				if ((Class122.method1319((byte) 1)
						- -4623726814665285853L * aLong6491) > 1000L) {
					Rectangle rectangle = graphics.getClipBounds();
					if (rectangle == null || (rectangle.width >= -639974669
							* Class78.anInt733
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("mc.paint(").append(')').toString());
		}
	}
	...
	public final void focusGained(FocusEvent focusevent) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("mc.focusGained(").append(')').toString());
		}
	}
	...
	public final void windowActivated(WindowEvent windowevent) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("mc.windowActivated(").append(')').toString());
		}
	}
	...
	public final void windowClosed(WindowEvent windowevent) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("mc.windowClosed(").append(')').toString());
		}
	}
	...
	public final void windowClosing(WindowEvent windowevent) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("mc.windowClosing(").append(')').toString());
		}
	}
	...
	public final void windowDeiconified(WindowEvent windowevent) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("mc.windowDeiconified(").append(')').toString());
		}
	}
	...
	public final void windowIconified(WindowEvent windowevent) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("mc.windowIconified(").append(')').toString());
		}
	}
	...
	public void start() {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("mc.start(").append(')').toString());
		}
	}
	...
	void method2764(byte i) {
		try {
			...
			Class402.anInt5227 = -1259443305
					* (1 + Class402.anInt5227 * -1495088089 & 0x1f);
			if (0L != l_25_ && l <= l_25_) {
				/* empty */
			}
			synchronized (this) {
			...
			throw Class346.method4175(runtimeexception,
					new StringBuilder().append("mc.m(").append(')').toString());
		}
	}
	...
	public boolean method2766(int i) {
		try {
			((Class291) this).aBoolean6501 = EmitterConfig
					.method955(-1461998657).method265("jaclib", 888400764);
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("mc.ai(").append(')').toString());
		}
	}

	public boolean method2767(int i) {
		try {
			return EmitterConfig.method955(-975726550).method265("jagtheora",
					1050805065);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("mc.al(").append(')').toString());
		}
	}
	...
	public final synchronized void method191(Graphics graphics) {
		if (!aBoolean6497) {
			...
			if ((Class122.method1319((byte) 1)
				...
				Rectangle rectangle = graphics.getClipBounds();
				if (rectangle == null
						|| (rectangle.width >= -639974669 * Class78.anInt733
								&& rectangle.height >= anInt6472 * 1282634425))
					aBoolean6478 = true;
			}
		}
	...
	public final void method194(Graphics graphics) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("mc.update(").append(')').toString());
		}
	}
	...
	public void method193() {
		try {
			if (!aBoolean6497) {
				aLong6496 = Class122.method1319((byte) 1)
						* -5427437724707662087L;
				IPAddress.method6060(5000L);
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("mc.destroy(").append(')').toString());
		}
	}
	...
	final void method2776(boolean bool, byte i) {
		try {
			...
			try {
				...
				for (int i_26_ = 0; i_26_ < 1210163253
						* Class310.anInt6512; i_26_++)
			...
			if (SubIncommingPacket.method1926(-1578689153))
				EmitterConfig.method955(-1456500375).method264(-242181565);
			if (Class52_Sub2_Sub1.aCanvas9079 != null) {
				try {
					Class52_Sub2_Sub1.aCanvas9079.removeFocusListener(this);
					Class52_Sub2_Sub1.aCanvas9079.getParent()
			...
			throw Class346.method4175(runtimeexception,
					new StringBuilder().append("mc.o(").append(')').toString());
		}
	}
	...
	void method2777(Container container, int i) {
		try {
			...
			Class52_Sub2_Sub1.aCanvas9079.setSize(
					-2110394505 * Class462.anInt5683,
					-1111710645 * Class298_Sub40_Sub9.anInt9716);
			Class52_Sub2_Sub1.aCanvas9079.setVisible(true);
			if (container == Class298_Sub36.aFrame7403) {
				Insets insets = Class298_Sub36.aFrame7403.getInsets();
				Class52_Sub2_Sub1.aCanvas9079.setLocation(
						insets.left + 1898544019 * anInt6473,
						anInt6474 * 540368727 + insets.top);
			} else
				Class52_Sub2_Sub1.aCanvas9079.setLocation(
						(1898544019 * anInt6473), (540368727 * anInt6474));
			...
			throw Class346.method4175(runtimeexception,
					new StringBuilder().append("mc.h(").append(')').toString());
		}
	}
	...
	void method2778(String string, int i) {
		try {
			if (!((Class291) this).aBoolean6498) {
				...
				System.out.println(new StringBuilder().append("error_game_")
						.append(string).toString());
				try {
					Class466.method6021(ClientScriptMap.anApplet6044,
							"loggedout", (short) 19911);
				} catch (Throwable throwable) {
					/* empty */
				}
				try {
					ClientScriptMap.anApplet6044.getAppletContext()
							.showDocument(new URL(
									ClientScriptMap.anApplet6044.getCodeBase(),
									new StringBuilder().append("error_game_")
											.append(string).append(".ws")
											.toString()),
									"_top");
				} catch (Exception exception) {
					/* empty */
	...
	public final void windowDeactivated(WindowEvent windowevent) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("mc.windowDeactivated(").append(')').toString());
		}
	}
	...
	synchronized void method2780(String string, int i) {
		try {
			...
			Insets insets = Class298_Sub36.aFrame7403.getInsets();
			Class298_Sub36.aFrame7403
					.setSize(
							(insets.right + (Class78.anInt733 * -639974669
									+ insets.left)),
					(anInt6472 * 1282634425 + insets.top + insets.bottom));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception,
					new StringBuilder().append("mc.z(").append(')').toString());
		}
	}
	...
	public final void focusLost(FocusEvent focusevent) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("mc.focusLost(").append(')').toString());
		}
	}

	File method2783(String string, String string_27_, int i, short i_28_) {
		try {
			String string_29_ = (i == 0
					? ""
					: new StringBuilder().append("").append(i).toString());
			Class180.aFile6528 = new File(Class83.aString765,
					new StringBuilder().append(Loader.SERVER_NAME + "_cl_").append(string)
							.append("_").append(string_27_).append(string_29_)
							.append(".dat").toString());
			...
			if (Class180.aFile6528.exists()) {
				try {
					...
					for (class298_sub53 = (new RsByteBuffer((int) class476
							.method6080(-840924897))); (class298_sub53.index
									* 385051775 < class298_sub53.buffer.length); class298_sub53.index += i_32_
											* 116413311) {
						i_32_ = (class476.method6081(class298_sub53.buffer,
								class298_sub53.index * 385051775,
								(class298_sub53.buffer.length
										- class298_sub53.index * 385051775),
								(short) -10746));
						if (i_32_ == -1)
				...
				while_74_ : for (int i_34_ = 0; i_34_ < MagnetConfig.aStringArray679.length; i_34_++) {
					for (int i_35_ = 0; i_35_ < Class216.aStringArray6657.length; i_35_++) {
						File file = new File(new StringBuilder()
								.append(Class216.aStringArray6657[i_35_])
								.append(MagnetConfig.aStringArray679[i_34_])
								.append(File.separatorChar).append(string)
								.append(File.separatorChar).toString());
						if (file.exists()
								&& method2753(new File(file, "test.dat"), true,
										-1984790861)) {
			...
			if (string_30_ == null) {
				string_30_ = new StringBuilder().append(Class83.aString765)
						.append(File.separatorChar).append(Loader.SERVER_NAME + "cache")
						.append(string_29_).append(File.separatorChar)
						.append(string).append(File.separatorChar)
						.append(string_27_).append(File.separatorChar)
						.toString();
				bool = true;
			}
			if (null != string_31_) {
			...
			throw Class346.method4175(runtimeexception,
					new StringBuilder().append("mc.b(").append(')').toString());
		}
	}

	abstract void method2784();

	public static Class319 method2785(Component component, boolean bool,
			short i) {
		try {
	...
	static final void method2786(Class403 class403, int i) {
		try {
			Class390 class390 = (((Class403) class403).aBoolean5261
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("mc.eq(").append(')').toString());
		}
	}

	static final void method2787(IComponentDefinition class105,
			Class119 class119, Class403 class403, int i) {
		try {
			class105.anInt1178 = (((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689)
					* 681479919]) * 1158843261;
			Tradution.method6054(class105, 510093055);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("mc.fy(").append(')').toString());
		}
	}
	...
	static final void method2788(Class403 class403, byte i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689)
					* 681479919 - 1)] = -1424956747 * class105.anInt1167;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("mc.pz(").append(')').toString());
		}
	}
	...
	static final void method2790(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((Class403) class403).anInt5239
					* 681479919
					- 1] = (((Class403) class403).aClass162_5252.method1756(
							(byte) 4)[(((Class403) class403).anIntArray5244[((Class403) class403).anInt5239
									* 681479919 - 1])]);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("mc.xv(").append(')').toString());
		}
	}

	static void method2791(int i, String string, String string_44_, int i_45_) {
		try {
			if (null != pb.aClass25_8711) {
				Class298_Sub36 class298_sub36 = Class18.method359(
						OutcommingPacket.aClass198_2088,
						pb.aClass25_8711.aClass449_330, (byte) 94);
				class298_sub36.aClass298_Sub53_Sub2_7396.writeShort(
						(1 + ConfigEntry.method1310(string,
								(byte) -1)
						+ ConfigEntry.method1310(string_44_, (byte) -1)),
						16711935);
				class298_sub36.aClass298_Sub53_Sub2_7396
						.putJagString(string_44_, (short) -29506);
				class298_sub36.aClass298_Sub53_Sub2_7396.write128Byte(i,
						(byte) 1);
				class298_sub36.aClass298_Sub53_Sub2_7396.putJagString(string,
						(short) 12393);
				pb.aClass25_8711.method390(class298_sub36, (byte) -120);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("mc.apk(").append(')').toString());
		}
	}
}
