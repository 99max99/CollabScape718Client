...
public final class IsaacCipher {
	...
	try {
		...
		if (file.exists())
		    ...
		    while_104_: for (int i_16_ = 0; i_16_ < MagnetConfig.aStringArray679.length; i_16_++) {
			for (int i_17_ = 0; i_17_ < Class216.aStringArray6657.length; i_17_++) {
			    File file_18_ = new File(new StringBuilder().append(Class216.aStringArray6657[i_17_]).append(MagnetConfig.aStringArray679[i_16_]).append(File.separatorChar).append("random.dat").toString());
			    if (file_18_.exists()) {
